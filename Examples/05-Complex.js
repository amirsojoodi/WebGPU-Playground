(async () => {
  ...
  const firstMatrix =
      new Float32Array([2 /* rows */, 2 /* columns */, 1, 2, 3, 4, 5, 6, 7, 8]);
  ...
  const resultMatrixBufferSize =
      Float32Array.BYTES_PER_ELEMENT * (2 + firstMatrix[0] * secondMatrix[1] * 2);
  ...
  const shaderModule = device.createShaderModule({
    code: `
        ...
        // complex + complex
        fn addCC(a : vec2<f32>, b : vec2<f32>) -> vec2<f32> {
        ...
        // complex * complex
        fn mulCC(a : vec2<f32>, b : vec2<f32>) -> vec2<f32> {
          var result = vec2<f32>(0.0, 0.0);
        ...
        // float + complex
        fn addFC(a : f32, b : vec2<f32>) -> vec2<f32> {
          var result = vec2<f32>(0.0, 0.0);
          result.x = a + b.x;
          result.y = b.y;
          return result;
        ...
        // float * complex
        fn mulFC(a : f32, b : vec2<f32>) -> vec2<f32> {
          var result = vec2<f32>(0.0, 0.0);
          result.x = a * b.x;
          result.y = a * b.y;
          return result;
